...
<%@ page import="com.project.eventos.utility.CustomUrl" %>
...
<meta charset="ISO-8859-1">
	...
	<link rel="apple-touch-icon" sizes="180x180" href="<%= CustomUrl.images_appleTouchIcon %>">
    <link rel="icon" type="image/png" sizes="32x32" href="<%= CustomUrl.images_favicon32x32 %>">
    <link rel="icon" type="image/png" sizes="16x16" href="<%=CustomUrl.images_favicon16x16 %>">
    <link rel="manifest" href="<%= CustomUrl.manifest %>">

    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="<%=CustomUrl.css_bootstrapMin%>">
    <!-- Site CSS -->
    <link rel="stylesheet" href="<%=CustomUrl.css_style%>">
    <!-- Responsive CSS -->
    <link rel="stylesheet" href="<%=CustomUrl.css_responsive%>">
    <!-- Custom CSS -->
    <link rel="stylesheet" href="<%=CustomUrl.css_custom%>">

    <!-- Modernizer for Portfolio -->
    <script src="<%= CustomUrl.modernizerJS %>"></script>
...
<body>
    ...
    <!-- ALL JS FILES -->
    <script src="<%= CustomUrl.allJS %>"></script>
    <!-- ALL PLUGINS -->
    <script src="<%= CustomUrl.customJS %>"></script>
    <script src="<%= CustomUrl.portfolioJS %>"></script>
    <script src="<%= CustomUrl.hoverdirJS %>"></script>    
